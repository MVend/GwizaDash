...
export const createReason = (data) => async (dispatch) => {
  try {
    ...
    const res = await HttpRequest.post('/staging/api/reasons', data);
...
export const deleteReason = (reason_id) => async (dispatch) => {
  try {
    const res = await HttpRequest.delete(`/staging/api/reasons/${reason_id}`);
    toast.success(res.message);
...
export const findAll = (data) => async (dispatch) => {
  try {
    ...
    const res = await HttpRequest.get(
      `/staging/api/reasons?group_id=${data.group_id}&page=${data.page}&size=${data.size}`
    );
...
export const findOne = (data) => async (dispatch) => {
  try {
    ...
    const res = await HttpRequest.get(`/staging/api/reasons/${data.reason_id}`);
...
export const updateReason = (data, reason_id) => async (dispatch) => {
  try {
    ...
    const res = await HttpRequest.put(`/staging/api/reasons/${reason_id}`, data);
    toast.success(res.message);
