...
export const create = (data) => async (dispatch) => {
  try {
    ...
    const res = await HttpRequest.post('/staging/api/approvals', data);
...
export const findAll = (data) => async (dispatch) => {
  try {
    ...
    const res = await HttpRequest.get(
      `/staging/api/approvals?group_id=${data.group_id}&page=0&size=1000`
    );
...
export const update = (data) => async (dispatch) => {
  try {
    ...
    const res = await HttpRequest.put('/staging/api/approvals/0', data);
